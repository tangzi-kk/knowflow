...
export declare const TAG_NAMES: Record<Tag, string>;
 ...
 */
export declare const CALLOUT_FIELD_MAP: CalloutFieldMap[];
/** OB→飞书 callout 整体配色（合并信息块用）。 */
export declare const DOC_INFO_CALLOUT: {
    readonly emoji: "📋";
    readonly 'background-color': "light-blue";
    readonly 'border-color': "blue";
};
/** 飞书 callout 背景色 → OB callout 类型。依据 `03_格式规范.md` §3.1。 */
export declare const FEISHU_BG_TO_OB_CALLOUT: Record<string, string>;
/** OB callout 类型 → 飞书 callout 配色。§3.1 反向。 */
export declare const OB_CALLOUT_TO_FEISHU: Record<string, {
    emoji: string;
    bg: string;
    border: string;
}>;
