...
(() => {
  ...
  async function onSyncClick() {
    ...
    try {
      ...
      if (!response?.ok || !response.result?.path || !response.result?.proposalId || response.result.requiresConfirmation !== true || response.result.protocolVersion !== PROTOCOL_VERSION) {
