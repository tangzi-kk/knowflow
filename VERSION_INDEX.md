...
| 组件 | 版本 | 源码/产物 | 状态 |
|---|---:|---|---|
| Obsidian `fs-TB` | `4.5.5` | `artifacts/fs-TB-Obsidian-4.5.5.zip` | 二级容器自动整理、失效索引清理，已完成本机插件升级验收 |
| 浏览器 `KnowFlow` | `4.5.5` | `artifacts/KnowFlow-Browser-4.5.5/`、同名 ZIP | 双端门禁与 GitHub Release 已完成 |
...
- 历史版本 4.3.0、文件夹编码基线 4.5.0、4.5.1、4.5.2、4.5.3、4.5.4 均已发布；当前版本 4.5.5：[GitHub Release v4.5.5](https://github.com/tangzi-kk/knowflow/releases/tag/v4.5.5)。
...
```text
artifacts/fs-TB-Obsidian-4.5.5.zip
```
...
```text
artifacts/KnowFlow-Browser-4.5.5/
```

也可以先解压 `artifacts/KnowFlow-Browser-4.5.5.zip`。浏览器应选择解压后的目录，不能直接选择 ZIP。
