...
<p align="center">
  <img src="https://img.shields.io/badge/development-4.0.0-blue" alt="development version">
...
| 分类 | 组件 | 版本 | 仓库内地址 | 状态 |
|---|---|---:|---|---|
| 开发线 | `fs-TB` + `KnowFlow` | `4.0.0` | `packages/ob-plugin/` + `extension/dist/` | 自动门禁通过，尚未真机安装 |
