...
(() => {
  ...
  var YAML_METADATA_DEFAULTS;
  var init_yaml = __esm({
    "../packages/shared/dist/yaml.js"() {
      "use strict";
      init_js_yaml();
      YAML_METADATA_DEFAULTS = Object.freeze({
        \u534F\u8BAE\u7248\u672C: 1,
        \u6807\u7B7E: "",
        \u7F16\u7801: "",
        \u77ED\u7F16\u7801: "",
  ...
  __export(client_exports, {
    ...
    chatWithOpenAiCompatible: () => chatWithOpenAiCompatible,
    getStatus: () => getStatus,
    getTree: () => getTree,
  ...
  async function chatWithOpenAiCompatible(config, messages, options = {}) {
  ...
  async function suggestMetaWithInterpreter(config, input) {
    ...
    const content = await chatWithOpenAiCompatible(
      config,
      [
        {
          role: "system",
  ...
  async function runLocalAiFallback(fullPrompt, attachments = []) {
