...
${input.excerpt || ""}`,
  ...
  function formatProposalLandingStatus(landingMessage, result) {
    if (result.proposalId && result.requiresConfirmation === true && result.protocolVersion === PROTOCOL_VERSION) {
